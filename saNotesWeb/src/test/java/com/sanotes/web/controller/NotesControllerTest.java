...
class NotesControllerTest {
    ...
    void updateNote() throws Exception {
        ...
        MockHttpServletRequestBuilder request = put("/api/v1/note");
        request.content(mapper.writeValueAsString(note));
        request.accept(MEDIA_TYPE_JSON_UTF8);
        request.contentType(MEDIA_TYPE_JSON_UTF8);
        MockHttpServletResponse response = mockMvc.perform(request)
    ...
    void getNote() throws Exception {
        ...
        MediaType MEDIA_TYPE_JSON_UTF8 =
                new MediaType("application", "json", java.nio.charset.Charset.forName("UTF-8"));
        MockHttpServletRequestBuilder request = get("/api/v1/note");
        request.param("id", "1");
        request.accept(MEDIA_TYPE_JSON_UTF8);
        request.contentType(MEDIA_TYPE_JSON_UTF8);
        MockHttpServletResponse response = mockMvc.perform(request)
    ...
    void getNoteVersions() throws Exception {
        ...
        MediaType MEDIA_TYPE_JSON_UTF8 =
                new MediaType("application", "json", java.nio.charset.Charset.forName("UTF-8"));
        MockHttpServletRequestBuilder request = get("/api/v1/note/versions");
        request.param("id", "1");
        request.accept(MEDIA_TYPE_JSON_UTF8);
        request.contentType(MEDIA_TYPE_JSON_UTF8);
        MockHttpServletResponse response = mockMvc.perform(request)
    ...
    void deleteNote() throws Exception {
        ...
        MediaType MEDIA_TYPE_JSON_UTF8 =
                new MediaType("application", "json", java.nio.charset.Charset.forName("UTF-8"));
        MockHttpServletRequestBuilder request = delete("/api/v1/note");
